// In src/components/ProductItem.jsx
import { formatePrize } from "../../utils/helpers";  // Import formatePrize from helpers.js
      ...
      <div className="p-4">
        ...
        <div className="mt-4 flex items-center justify-between">
          <span className="text-lg font-bold text-gray-800">
            {formatePrize(product.price)}  {/* Call the formatePrize function here */}
          </span>
          <button
